export const HomeHero = () => {
    return(
        <section class="py-24 flex items-center min-h-[85vh] justify-center">
            <div class="mx-auto max-w-[43rem]">
                ...
                <button class="transform rounded-md bg-indigo-600/95 px-5 py-3 font-medium text-white transition-colors hover:bg-indigo-700">Get started for free</button>
                <button class="transform rounded-md border border-slate-200 px-5 py-3 font-medium text-slate-900 transition-colors hover:bg-slate-50"> Request a demo </button>
                </div>
            </div>
        </section>
    )
