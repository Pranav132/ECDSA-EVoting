        ...
        <section className="py-24 flex items-center min-h-[85vh] justify-center">
            <div className="mx-auto max-w-[43rem]">
                <div className="text-center">
                    ...
                    <h1 className="mt-3 text-[3.5rem] font-bold leading-[4rem] tracking-tight text-black">Vote using the Elliptic Curve Digital Signature Algorithm.</h1>
                    <p className="mt-3 text-lg leading-relaxed text-slate-400">Vote for your favourite programming language using ECDSA.</p>
                </div>
